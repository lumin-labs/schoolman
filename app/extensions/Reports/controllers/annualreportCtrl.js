'use strict';
define(['Location','Marksheets', 'Forms', 'Groups', 'Departments', 'ClassCouncils', 'Students', 'Subjects', 'Lang'], function(Location, Marksheets, Forms, Groups, Departments, ClassCouncils, Students, Subjects, Lang){
