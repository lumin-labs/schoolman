...
function StaffsfinanceCtrl($scope, $routeParams, Forms, Registrar, Salarys, Staffs, Payments, SchoolInfos, Lang) {
   ...
   var stringToNumber = function(amount){
    ...
    Students.query().then(function(staffs){
      allStudents = staffs;
    }).catch(function(error){
...
FinanceCtrl.$inject = ['$scope', '$routeParams', 'Forms', 'Registrar', 'Salarys', 'Staffs', 'Payments', 'SchoolInfos', 'Lang'];
angular.module('SchoolMan').controller('StaffsfinanceCtrl', StaffsfinanceCtrl);
