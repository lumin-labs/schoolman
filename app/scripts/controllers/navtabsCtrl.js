...
function NavtabsCtrl($scope, $routeParams, Location, TABS, MODULES, settings, Cache, model, SchoolInfos, Lang) {
  ...
  NavtabsCtrl.$inject = ['$scope', '$routeParams', 'Location', 'TABS', 'MODULES', 'settings', 'Cache', 'model', 'SchoolInfos', 'Lang'];
