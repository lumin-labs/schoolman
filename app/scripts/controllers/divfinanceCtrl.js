...
function DivFinanceCtrl($scope, Forms, Registrar, Fees, Students, Payments, SchoolInfos) {
...
DivFinanceCtrl.$inject = ['$scope', 'Forms', 'Registrar', 'Fees', 'Students', 'Payments', 'SchoolInfos'];
