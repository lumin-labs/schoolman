...
function Staffpayments($q, model, modelTransformer, Salarys, Staffs, pouchdb) {
...
Staffpayments.$inject = ['$q', 'model', 'modelTransformer', 'Salarys', 'Staffs', 'pouchdb'];
angular.module('SchoolMan').service('Staffpayments', Staffpayments);